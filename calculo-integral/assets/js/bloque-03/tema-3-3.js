...
(() => {
const NUM="3.3",BANK={"basic": [{"p": "Calcula ∬_R 2 dA sobre R=[0,1.5]×[0,2].", "a": 6.0, "h": "Constante × área del rectángulo."}, {"p": "Calcula ∬_R 2 dA sobre R=[0,2.0]×[0,3].", "a": 12.0, "h": "Constante × área del rectángulo."}, {"p": "Calcula ∬_R 2 dA sobre R=[0,2.5]×[0,1].", "a": 5.0, "h": "Constante × área del rectángulo."}, {"p": "Calcula ∬_R 2 dA sobre R=[0,3.0]×[0,2].", "a": 12.0, "h": "Constante × área del rectángulo."}, {"p": "Calcula ∬_R 2 dA sobre R=[0,3.5]×[0,3].", "a": 21.0, "h": "Constante × área del rectángulo."}, {"p": "Calcula ∬_R 2 dA sobre R=[0,4.0]×[0,1].", "a": 8.0, "h": "Constante × área del rectángulo."}], "medium": [{"p": "Calcula ∫₀^2∫₀^2(x+y)dy dx.", "a": 8.0, "h": "Integra primero respecto de y."}, {"p": "Calcula ∫₀^3∫₀^1(x+y)dy dx.", "a": 6.0, "h": "Integra primero respecto de y."}, {"p": "Calcula ∫₀^1∫₀^2(x+y)dy dx.", "a": 3.0, "h": "Integra primero respecto de y."}, {"p": "Calcula ∫₀^2∫₀^1(x+y)dy dx.", "a": 3.0, "h": "Integra primero respecto de y."}, {"p": "Calcula ∫₀^3∫₀^2(x+y)dy dx.", "a": 15.0, "h": "Integra primero respecto de y."}, {"p": "Calcula ∫₀^1∫₀^1(x+y)dy dx.", "a": 1.0, "h": "Integra primero respecto de y."}], "hard": [{"p": "S(x,y)=1+x+y W/m² sobre [0,1.5]×[0,2]. Calcula potencia total.", "a": 8.25, "h": "P=∬S dA."}, {"p": "S(x,y)=1+x+y W/m² sobre [0,2.0]×[0,3]. Calcula potencia total.", "a": 21.0, "h": "P=∬S dA."}, {"p": "S(x,y)=1+x+y W/m² sobre [0,2.5]×[0,1]. Calcula potencia total.", "a": 6.875, "h": "P=∬S dA."}, {"p": "S(x,y)=1+x+y W/m² sobre [0,3.0]×[0,2]. Calcula potencia total.", "a": 21.0, "h": "P=∬S dA."}, {"p": "S(x,y)=1+x+y W/m² sobre [0,3.5]×[0,3]. Calcula potencia total.", "a": 44.625, "h": "P=∬S dA."}, {"p": "S(x,y)=1+x+y W/m² sobre [0,4.0]×[0,1]. Calcula potencia total.", "a": 14.0, "h": "P=∬S dA."}]},ANS={"q1": 0, "q2": 0, "q3": 0, "q4": 0},q=s=>document.querySelector(s),qa=s=>[...document.querySelectorAll(s)],fmt=(x,d=6)=>Number(x).toFixed(d).replace(/0+$/,'').replace(/\.$/,'');
