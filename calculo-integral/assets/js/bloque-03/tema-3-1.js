...
(() => {
const NUM="3.1",BANK={"basic": [{"p": "Área bajo y=x en [0,1.5].", "a": 1.125, "h": "Integra x: x²/2."}, {"p": "Área bajo y=x en [0,2.0].", "a": 2.0, "h": "Integra x: x²/2."}, {"p": "Área bajo y=x en [0,2.5].", "a": 3.125, "h": "Integra x: x²/2."}, {"p": "Área bajo y=x en [0,3.0].", "a": 4.5, "h": "Integra x: x²/2."}, {"p": "Área bajo y=x en [0,3.5].", "a": 6.125, "h": "Integra x: x²/2."}, {"p": "Área bajo y=x en [0,4.0].", "a": 8.0, "h": "Integra x: x²/2."}], "medium": [{"p": "Área entre y=1x y y=x² en [0,1].", "a": 0.16666666666666669, "h": "En [0,1], integra 1x−x²."}, {"p": "Área entre y=2x y y=x² en [0,1].", "a": 0.6666666666666667, "h": "En [0,1], integra 2x−x²."}, {"p": "Área entre y=3x y y=x² en [0,1].", "a": 1.1666666666666667, "h": "En [0,1], integra 3x−x²."}, {"p": "Área entre y=4x y y=x² en [0,1].", "a": 1.6666666666666667, "h": "En [0,1], integra 4x−x²."}, {"p": "Área entre y=5x y y=x² en [0,1].", "a": 2.1666666666666665, "h": "En [0,1], integra 5x−x²."}, {"p": "Área entre y=6x y y=x² en [0,1].", "a": 2.6666666666666665, "h": "En [0,1], integra 6x−x²."}], "hard": [{"p": "Volumen al girar y=x en [0,1.5] alrededor del eje x.", "a": 3.5342917352885173, "h": "V=π∫x²dx."}, {"p": "Volumen al girar y=x en [0,2.0] alrededor del eje x.", "a": 8.377580409572781, "h": "V=π∫x²dx."}, {"p": "Volumen al girar y=x en [0,2.5] alrededor del eje x.", "a": 16.36246173744684, "h": "V=π∫x²dx."}, {"p": "Volumen al girar y=x en [0,3.0] alrededor del eje x.", "a": 28.274333882308138, "h": "V=π∫x²dx."}, {"p": "Volumen al girar y=x en [0,3.5] alrededor del eje x.", "a": 44.89859500755413, "h": "V=π∫x²dx."}, {"p": "Volumen al girar y=x en [0,4.0] alrededor del eje x.", "a": 67.02064327658225, "h": "V=π∫x²dx."}]},ANS={"q1": 0, "q2": 0, "q3": 0, "q4": 0},q=s=>document.querySelector(s),qa=s=>[...document.querySelectorAll(s)],fmt=(x,d=6)=>Number(x).toFixed(d).replace(/0+$/,'').replace(/\.$/,'');
